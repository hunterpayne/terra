 ...
 *
 * The primary type, [[org.terra.market.MoneyLike]], is derived from Quantity, and its Units of Measure are Currencies.
 ...
 *
 * [[org.terra.market.Price]]s represent a Ratio between Money and some other Quantity.  Prices can be created from
 ...
 * }}}
 *
 * [[org.terra.market.CurrencyExchangeRate]]s represent conversion rates between currencies.
 * Use them to explicitly convert Money values in one currency to values in another.
 *
 * [[org.terra.market.MoneyContextLike]] provide the implicit context necessary to perform cross-currency operations
