...
import org.terra.{ QuantityParseException, CustomMatchers }
...
class DataRateSpec 
  ...
  it should "properly convert to all supported Units of Measure" in {
    ...
    implicit val tolerance: Double = 0.000000000000000000000001
    val x = BytesPerSecond(1l)
    x.toBytesPerSecond should be(1)

    x.toKilobytesPerSecond should be(0.001)
    x.toMegabytesPerSecond should be(0.000001)
    x.toGigabytesPerSecond should be(0.000000001)
    x.toTerabytesPerSecond should be(0.000000000001)
    x.toPetabytesPerSecond should be(0.000000000000001)
    x.toExabytesPerSecond should be(0.000000000000000001)
    x.toZettabytesPerSecond should be(0.000000000000000000001)
    x.toYottabytesPerSecond should beApproximately(0.000000000000000000000001)

    x.toKibibytesPerSecond should be(1.0 / 1024.0)
    x.toMebibytesPerSecond should be(1.0 / scala.math.pow(2, 20))
    x.toGibibytesPerSecond should be(1.0 / scala.math.pow(2, 30))
    x.toTebibytesPerSecond should be(1.0 / scala.math.pow(2, 40))
    x.toPebibytesPerSecond should be(1.0 / scala.math.pow(2, 50))
    x.toExbibytesPerSecond should be(1.0 / scala.math.pow(2, 60))
    x.toZebibytesPerSecond should be(1.0 / scala.math.pow(2, 70))
    x.toYobibytesPerSecond should be(1.0 / scala.math.pow(2, 80))

    x.toBitsPerSecond should be(8.0)
    x.toKilobitsPerSecond should be(0.008)
    x.toMegabitsPerSecond should be(0.000008)
    x.toGigabitsPerSecond should be(0.000000008)
    x.toTerabitsPerSecond should be(0.000000000008)
    x.toPetabitsPerSecond should be(0.000000000000008)
    x.toExabitsPerSecond should beApproximately(0.000000000000000008)
    x.toZettabitsPerSecond should beApproximately(0.000000000000000000008)
    x.toYottabitsPerSecond should beApproximately(0.000000000000000000000008)

    x.toKibibitsPerSecond should be(8.0 / 1024.0)
    x.toMebibitsPerSecond should be(8.0 / scala.math.pow(2, 20))
    x.toGibibitsPerSecond should be(8.0 / scala.math.pow(2, 30))
    x.toTebibitsPerSecond should be(8.0 / scala.math.pow(2, 40))
    x.toPebibitsPerSecond should be(8.0 / scala.math.pow(2, 50))
    x.toExbibitsPerSecond should be(8.0 / scala.math.pow(2, 60))
    x.toZebibitsPerSecond should be(8.0 / scala.math.pow(2, 70))
    x.toYobibitsPerSecond should be(8.0 / scala.math.pow(2, 80))
  }
