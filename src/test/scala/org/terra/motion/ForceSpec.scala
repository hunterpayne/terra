...
class ForceSpec extends FlatSpec with Matchers with CustomMatchers {
  ...
  it should "provide aliases for single unit values" in {
    ...
    kiloElectronVoltPerMicrometer should be(KiloElectronVoltsPerMicrometer(1))
    megaElectronVoltPerCentimeter should be(MegaElectronVoltsPerCentimeter(1))
  }
  ...
  it should "provide implicit conversion from Double" in {
    ...
    d.kiloElectronVoltPerMicrometer should be (KiloElectronVoltsPerMicrometer(d))
    d.megaElectronVoltPerCentimeter should be (MegaElectronVoltsPerCentimeter(d))
  }
