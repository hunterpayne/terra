 ...
 *
 */
class TimeLongSpec extends FlatSpec with Matchers {

  behavior of "Time (as Long) and its Units of Measure"
  ...
  it should "return Time when added to Time" in {
    ...
    Minutes(15) + Hours(2) should be(Minutes(135))
  }
  ...
  it should "properly convert to all supported Units of Measure" in {
    ...
    x1.toMinutes should be(24 * 60)
    x1.toHours should be(24)
    x1.toDays should be(1)
  }
