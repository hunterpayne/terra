...
import standard.StandardTerraOps
import standard.electro.{ Webers, MagneticFlux, Volts, Teslas, Henry, Amperes, MagneticFluxConversions }
...
class MagneticFluxSpec extends FlatSpec with Matchers {
  ...
  it should "provide implicit conversion from Double" in {
    import MagneticFluxConversions.MagneticFluxConversions
