...
import standard.space.{ SquareMeters, SquareCentimeters }
...
class AreaTimeSpec extends FlatSpec with Matchers {
  ...
  it should "provide aliases for single unit values" in {
    ...
    squareMeterSecond should be(SquareMeterSeconds(1))
    squareCentimeterSecond should be(SquareCentimeterSeconds(1))
  }
