...
class SpectralIrradianceSpec extends FlatSpec with Matchers {
  ...
  it should "create values using UOM factories" in {
    WattsPerCubicMeterIrradiance(1).toWattsPerCubicMeter should be(1)
  ...
  it should "create values from properly formatted Strings" in {
    SpectralIrradiance("10.22 W/m³").get should be(WattsPerCubicMeterIrradiance(10.22))
  ...
  it should "properly convert to all supported Units of Measure" in {
    val x = WattsPerCubicMeterIrradiance(1)
  ...
  it should "return properly formatted strings for all supported Units of Measure" in {
    WattsPerCubicMeterIrradiance(1).toString should be("1.0 W/m³")
  ...
  it should "provide aliases for single unit values" in {
    ...
    wattPerCubicMeter should be(WattsPerCubicMeterIrradiance(1))
  ...
  it should "provide implicit conversion from Double" in {
    ...
    val d = 10.22d
    d.wattsPerCubicMeter should be(WattsPerCubicMeterIrradiance(d))
  ...
  it should "provide Numeric support" in {
    ...
    val irrsWPCM = List(WattsPerCubicMeterIrradiance(10), WattsPerCubicMeterIrradiance(100))
    irrsWPCM.sum should be(WattsPerCubicMeterIrradiance(110))
